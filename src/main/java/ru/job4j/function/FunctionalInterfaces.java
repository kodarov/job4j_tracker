...
public class FunctionalInterfaces {
    public static void main(String[] args) {
        ...
        BiPredicate<Integer, String> biPredicate = (integer, string) -> integer % 2 == 0 || string.equals(map.get(integer));
        for (Integer key : map.keySet()) {
            if (biPredicate.test(key, "seven")) {
        ...
        Consumer<String> consumer = string -> System.out.format(string + System.lineSeparator());
